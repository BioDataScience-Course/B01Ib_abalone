...
L'étude globale souhaite modéliser l'age des ormeaux sur base de mesures morphologiques. Ce carnet de notes s'intéresse à l'évolution de la masse en fonction de la longueur de la coquille comme analyse préliminaire.
