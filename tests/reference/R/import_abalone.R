...
# Remarque : lorsque vous voyez du code comme "; RNMD5('abalone1')" à la fin
...
abalone <- read$csv(
  ...
  cache_file = "data/data_raw/abalone_raw.csv"); RNMD5('abalone1')
...
abalone <- smutate(abalone, age = ___); RNMD5('abalone2')
